...
def main(argv):
    ...
    try:
        opts, args = getopt.getopt(
            argv,
            "A:t:c:u:g:m:n:r:J:w:x:l:hdaijp:sz:P:D:T:IU:",
            ["hook=", "auto", "autooff"],
        )
    ...
    if config_file:
        ...
        with open(config_file) as f:
            try:
                ...
                logging.warning(
                    "Failed to load config file " + config_file + " " + str(e)
                )
                sys.exit(3)
    elif config_url:
    ...
    if running_in_docker():
        if use_af and af_supported:
            ...
            with open(yaml_file, "w") as yf:
                ...
                jobs.append(
                    get_af_output_summary(
                        ("Short", "Long")[detailed_output],
                        summary_file,
                        config_dict,
                        config_msg,
                    )
